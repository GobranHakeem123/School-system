...
<body>
  ...
  <h1>إنشاء واستعادة النسخ الاحتياطية</h1>

  <button class="btnreport" onclick="createBackup()">إنشاء نسخة احتياطية</button>
  <button class="btnreport" onclick="restoreBackup()">استعادة النسخة الاحتياطية</button>

  <script>
    function createBackup() {
      // قم بإضافة الشيفرة هنا لإنشاء نسخة احتياطية لقاعدة البيانات وحفظها في ملف خارجي
      // في هذا المثال، سنستخدم alert لإظهار رسالة تأكيد
      alert("تم إنشاء نسخة احتياطية لقاعدة البيانات وحفظها في ملف خارجي.");
    }

    function restoreBackup() {
      // قم بإضافة الشيفرة هنا لاستعادة النسخة الاحتياطية من ملف خارجي إلى قاعدة البيانات
      // في هذا المثال، سنستخدم alert لإظهار رسالة تأكيد
      alert("تم استعادة النسخة الاحتياطية واستعادة البيانات إلى قاعدة البيانات.");
    }
  </script>
