...
color: black;
        ...
        <form action="?" method="POST">
            ...
            <textarea id="notification" rows="4" cols="50" class="form-input"  placeholder="اكتب هنا..." name="not"></textarea>
            <br><br>
           ...
           <input type="submit" value="ارسال"class="btnreport" onclick="sendNotification()" name="submit"> 
           </form>      
<?php
$note = $_POST['not'];
$sql = "INSERT INTO `notifications`( `noti`) VALUES ('$note')";
