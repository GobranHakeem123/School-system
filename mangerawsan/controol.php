...
<style>.form-input{
  background-color: rgba(127, 255, 212, 0);
            ...
            <button class="btnreport" id="executeButton" onclick="toggleForm()">سجل الدرجات الشهرية</button>
...
<!--  -->
    <button class="btnreport" id="toggleCodeButton" onclick="toggleCode()">  سجل الدرجات الفصلية</button>
...
<!--  -->
<button class="btnreport" id="toggleTableButton" onclick="toggleTable()">سجل الدرجات السنوية</button>
<br>
<div >
    <?php
