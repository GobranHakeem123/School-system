...
<nav class="navbar">
  ...
  <ul class="navbar-list">
    ...
    <li class="navbar-item">
      <button class="navbar-link  active" ><a href="aadadat.php" class="social-link">الاعدادات</a></button>
    </li>
...
<header>
  <h2 class="h2 article-title">تغير كلمة السر</h2>
</header>
<div id="subjects" style="display: block;">
<input type="text" id="searchInput" placeholder= "ادخل كلمة المرور القديمة" class="filter-select">
<br>
<button  onclick="displayAssignments()" class="btns">تغير كلمة السر</button>
<br>
</dev>
<div id="assignments" style="display: none;">
<input type="text" id="searchInput" placeholder= "ادخل كلمة المرور الجديدة" class="filter-select">
<br>
<button class="btns">تاكيد</button>
